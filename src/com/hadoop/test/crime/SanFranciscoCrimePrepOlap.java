...
public class SanFranciscoCrimePrepOlap extends MapReduceJobBase implements Tool {
	...
	public static void main(String[] args) throws Exception {
		String[] args0 = {
				"hdfs://djt:9000/middle/crime/crime.csv",
				"hdfs://djt:9000/middle/crime/out1/part-r-00000",
				"hdfs://djt:9000/middle/crime/out2/part-r-00000",
				"hdfs://djt:9000/middle/crime/out3/"};
		if (args0.length == 4) {
			Configuration conf = new Configuration();
			FileSystem fs = FileSystem.get(URI.create("hdfs://djt:9000"), conf);
			//调用setup
