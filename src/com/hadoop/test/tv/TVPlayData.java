...
public class TVPlayData implements WritableComparable<Object>{
	...
	public TVPlayData(int daynumber, int collectnumber, int commentnumber,
			int againstnumber, int supportnumber) {
	...
	public void set(int daynumber, int collectnumber, int commentnumber, int againstnumber,
			int supportnumber) {
		this.daynumber = daynumber;
		this.collectnumber = collectnumber;
		this.commentnumber = commentnumber;
