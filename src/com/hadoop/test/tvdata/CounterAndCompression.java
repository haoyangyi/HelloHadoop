package com.hadoop.test.tvdata;
...
public class CounterAndCompression extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "CounterAndCompression");//新建一个任务
	...
	public static void main(String[] args) throws Exception {		
		...
		int ec = 1;
		for(String dt:date){
			String[] args0 = { "hdfs://djt:9000/middle/tv/"+dt+".txt",
			"hdfs://djt:9000/middle/tv/result/"+dt };
