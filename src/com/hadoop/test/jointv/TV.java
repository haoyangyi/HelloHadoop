package com.hadoop.test.jointv;
...
public class TV  extends Configured implements Tool {
	...
	public static class TelevisionMapper extends Mapper<Object, Text, Text, MapWritable> {
		...
		protected void setup(Context context) throws IOException,
			...
			//创建FileSystem
			FileSystem fs = FileSystem.get(URI.create("hdfs://djt:9000"), context.getConfiguration());
	...
	public static void main(String[] args) throws Exception {
		String[] arg = { 
				"hdfs://djt:9000/middle/tv/result/",
				"hdfs://djt:9000/middle/jointv/ctype/",
				"hdfs://djt:9000/middle/jointv/channelType.csv"};
